...
## Frontend
- [1] **Passo**:  Abra o termina e entre na pasta frontend executa o comadno `npm install`.
...
- [4] **Passo**:  Para consfigurar a conexão com o banco de dados renomeia o aquivo `env_exemplo` para `.env`  e configura as conecções
